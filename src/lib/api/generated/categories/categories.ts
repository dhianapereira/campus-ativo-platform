...
export const getFetchCategoriesControllerHandleQueryOptions = <TData = Awaited<ReturnType<typeof fetchCategoriesControllerHandle>>, TError = ErrorType<void>>(params?: FetchCategoriesControllerHandleParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof fetchCategoriesControllerHandle>>, TError, TData>>, request?: SecondParameter<typeof axiosInstance>}
) => {
...
export type FetchCategoriesControllerHandleQueryError = ErrorType<void>


export function useFetchCategoriesControllerHandle<TData = Awaited<ReturnType<typeof fetchCategoriesControllerHandle>>, TError = ErrorType<void>>(
...
export const getCreateCategoryControllerHandleMutationOptions = <TError = ErrorType<void>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateCategoryControllerHandleMutationError = ErrorType<void>

    /**
 * @summary Criar categoria
 */
export const useCreateCategoryControllerHandle = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createCategoryControllerHandle>>, TError,{data: BodyType<CreateCategoryRequest>}, TContext>, request?: SecondParameter<typeof axiosInstance>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getCreateCategoryControllerHandleMutationOptions(options), queryClient);
    }
    /**
...
export const editCategoryControllerHandle = (
 ...
 options?: SecondParameter<typeof axiosInstance>,signal?: AbortSignal
      ...
      headers: {'Content-Type': 'application/json', },
      data: editCategoryRequest, signal
    },
      options);
    }
...
export const getEditCategoryControllerHandleMutationOptions = <TError = ErrorType<void>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type EditCategoryControllerHandleMutationError = ErrorType<void>

    /**
 * @summary Editar categoria
 */
export const useEditCategoryControllerHandle = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof editCategoryControllerHandle>>, TError,{id: string;data: BodyType<EditCategoryRequest>}, TContext>, request?: SecondParameter<typeof axiosInstance>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getEditCategoryControllerHandleMutationOptions(options), queryClient);
    }
    /**
...
export const getDeleteCategoryControllerHandleMutationOptions = <TError = ErrorType<void>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteCategoryControllerHandleMutationError = ErrorType<void>

    /**
 * @summary Deletar categoria
 */
export const useDeleteCategoryControllerHandle = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteCategoryControllerHandle>>, TError,{id: string}, TContext>, request?: SecondParameter<typeof axiosInstance>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getDeleteCategoryControllerHandleMutationOptions(options), queryClient);
    }
    /**
...
export const trashCategoryControllerHandle = (
 ...
 options?: SecondParameter<typeof axiosInstance>,signal?: AbortSignal
      ...
      return axiosInstance<void>(
      {url: `/categories/${id}/trash`, method: 'PATCH', signal
    },
      options);
    }
...
export const getTrashCategoryControllerHandleMutationOptions = <TError = ErrorType<void>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type TrashCategoryControllerHandleMutationError = ErrorType<void>

    /**
 * @summary Mover categoria para lixeira
 */
export const useTrashCategoryControllerHandle = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof trashCategoryControllerHandle>>, TError,{id: string}, TContext>, request?: SecondParameter<typeof axiosInstance>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getTrashCategoryControllerHandleMutationOptions(options), queryClient);
    }
    /**
...
export const restoreCategoryControllerHandle = (
 ...
 options?: SecondParameter<typeof axiosInstance>,signal?: AbortSignal
      ...
      return axiosInstance<void>(
      {url: `/categories/${id}/restore`, method: 'PATCH', signal
    },
      options);
    }
...
export const getRestoreCategoryControllerHandleMutationOptions = <TError = ErrorType<void>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RestoreCategoryControllerHandleMutationError = ErrorType<void>

    /**
 * @summary Restaurar categoria da lixeira
 */
export const useRestoreCategoryControllerHandle = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof restoreCategoryControllerHandle>>, TError,{id: string}, TContext>, request?: SecondParameter<typeof axiosInstance>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getRestoreCategoryControllerHandleMutationOptions(options), queryClient);
    }
